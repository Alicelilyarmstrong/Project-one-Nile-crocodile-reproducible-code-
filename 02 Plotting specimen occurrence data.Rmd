...
```{r}
map1<-ggplot(baseMap) +
  geom_sf(fill = "white", lwd = 0.4) +
  # Add species
  geom_sf(data = fiftyyrs11, colour = "blue", size = 2, alpha=0.5) +
  # Add equator line
...
map2<-ggplot(baseMap) +
  geom_sf(fill = "white", lwd = 0.4) +
  # Add species
  geom_sf(data = fiftyyrs22, colour = "blue", size = 2, alpha=0.5) +
  # Add equator line
  geom_hline(aes(yintercept = 0), colour = "black") +
...
map3<-ggplot(baseMap) +
  geom_sf(fill = "white", lwd = 0.4) +
  # Add species
  geom_sf(data = fiftyyrs33, colour = "blue", size = 2, alpha=0.5) +
  # Add equator line
  geom_hline(aes(yintercept = 0), colour = "black") +
...
```{r}
specimindata + plot_annotation (tag_levels= 'i')
```